 ...
 *
 * Disassembly of /Volumes/EFIMACOS/EFI/CLOVER/ACPI/origin/SSDT-7.aml, Tue Mar 24 01:40:50 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00001B6E (7022)
 *     Revision         0x01
 *     Checksum         0x99
 *     OEM ID           "OptRef"
...
DefinitionBlock ("", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    External (_PR_.CPU0.CPPC, IntObj)
    External (_PR_.CPU1.CPPC, IntObj)
    External (_PR_.CPU2.CPPC, IntObj)
    External (_PR_.CPU3.CPPC, IntObj)
    External (_PR_.CPU4.CPPC, IntObj)
    External (_PR_.CPU5.CPPC, IntObj)
    External (_PR_.CPU6.CPPC, IntObj)
    External (_PR_.CPU7.CPPC, IntObj)
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        ...
        Method (GC6O, 0, Serialized)
        {
            ...
            While ((\_SB.GGIV (0x01010015) != Zero))
            {
                Sleep (One)
            }
        ...
        Method (GPS, 4, Serialized)
        {
            ...
            Switch (ToInteger (Arg2))
            {
                ...
                Case (0x22)
                {
                    ...
                    \_PR.CPU0.CPPC = PCAP /* \_SB_.PCI0.PEG0.PEGP.GPS_.PCAP */
                    PNOT ()
